...
const seedHeroesTable = _ => {
    ...
    ('Frodo Baggins', 1, 'images/01.png', 1, 'frodo-baggins'),
    ('Samwise Gamgee', 1, 'images/02.png', 15, 'samwise-gamgee'),
    ('Gandalf', 1, 'images/03.png', 1, 'gandalf'),
    ('Harry Potter', 0, 'images/04.png', 12, 'harry-potter'),
    ('Hermione Granger', 1, 'images/05.png', 12, 'hermione-granger'),
    ('Ron Weasley', 0, 'images/06.png', 2, 'ron-weasley'),
    ('Jack Torrance', 0, 'images/07.png', 3, 'jack-torrance'),
    ('Wendy Torrance', 1, 'images/08.png', 6, 'wendy-torrance'),
    ('Danny Torrance', 0, 'images/09.png', 3, 'danny-torrance'),
    ('Ned Stark', 1, 'images/10.png', 4, 'ned-stark'),
    ('Catelyn Stark', 0, 'images/11.png', 7, 'catelyn-stark'),
    ('Robb Stark', 1, 'images/12.png', 8, 'robb-stark'),
    ('Tyrion Lannister', 1, 'images/13.png', 5, 'tyrion-lannister'),
    ('Daenerys Targaryen', 1, 'images/14.png', 9, 'daenerys-targaryen'),
    ('Jon Snow', 1, 'images/15.png', 5, 'jon-snow'),
    ('Cersei Lannister', 0, 'images/16.png', 10, 'cersei-lannister'),
    ('Jaime Lannister', 0, 'images/17.png', 6, 'jaime-lannister')
    `;
	connection.query(sql, function (err) {
		if (err) throw err;
